...
import OutfitGenerator from "./components/outfit/OutfitGenerator.jsx";
...
function TryOn() {
  ...
  useEffect(() => {
    console.log("Fetching /tryon...");
    fetch("/tryon", { credentials: "include" })
      .then((response) => {
  ...
  if (error) {
    return <div>Error loading Try-On page: {error}</div>;
  }
